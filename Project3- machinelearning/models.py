    ...
    def train(self, dataset):
        ...
        while True:
            for x, y in dataset.iterate_once(1):
                ...
                #updating weights based on gradients and learning rate
                self.w1.update(g[0],-self.LearningRate)
                self.w2.update(g[1],-self.LearningRate)
                self.b1.update(g[2],-self.LearningRate)
                self.b2.update(g[3],-self.LearningRate)
...
class DigitClassificationModel(object):
    ...
    def __init__(self):
        ...
        self.w1 = nn.Parameter(28*28,150)
